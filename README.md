...
| `<datasource>.hashing.collation`    | Optional. Specifies the collation for the VARCHAR/CHAR columns used in the sorting ordering when hashing the data of the tables. This is particularly useful when two databases use different collations and sort rows in different order by default |
